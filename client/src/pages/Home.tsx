    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="bg-[#F5E6D3] py-16 md:py-20 px-4 border-t border-[#C8102E]/20 overflow-hidden" id="marx">
        <div className="container max-w-5xl mx-auto overflow-hidden">
          <div
            className={`flex flex-col md:flex-row items-center gap-6 md:gap-8 transition-all duration-1000 overflow-hidden ${
          ...
          >
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-2xl md:text-4xl font-bold text-[#C8102E] mb-4 md:mb-6">MARX GABRIEL</h3>
      ...
      <section className="bg-[#F5E6D3] py-16 md:py-20 px-4 border-t border-[#C8102E]/20 overflow-hidden" id="geromel">
        <div className="container max-w-5xl mx-auto overflow-hidden">
          <div
            className={`flex flex-col md:flex-row-reverse items-center gap-6 md:gap-8 transition-all duration-1000 overflow-hidden ${
              isVisible['geromel']
                ? 'opacity-100 translate-y-0'
                : 'opacity-0 translate-y-10'
            }`}
          ...
          >
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-2xl md:text-4xl font-bold text-[#C8102E] mb-4 md:mb-6">RICARDO GEROMEL</h3>
